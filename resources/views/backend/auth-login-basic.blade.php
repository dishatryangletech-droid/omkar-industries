            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center mb-4 mt-2" style="height: auto !important;">
                <a href="{{ route('frontend.index') }}" class="app-brand-link" style="width: auto !important; height: auto !important;">
                  <img src="{{ asset('frontend/images/omkar-logo.png') }}" alt="Omkar Industries" style="width: 150px !important; height: auto !important; max-width: 100% !important;" />
                </a>
              </div>
              <!-- /Logo -->
              ...
              <form id="formAuthentication" class="mb-3" action="#" method="POST">
                ...
                <div class="mb-3">
                  <button class="btn btn-primary d-grid w-100" type="submit" style="background: linear-gradient(270deg, #ba0001 0%, #e60000 100%); border: none;">Sign in</button>
                </div>
              </form>
