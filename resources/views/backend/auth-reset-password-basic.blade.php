...
<head>
  ...
  <title>Reset Password Basic - Pages | Sundaram Corporation</title>
          ...
          <div class="card-body">
            ...
            <div class="app-brand justify-content-center mb-4 mt-2" style="height: auto !important;">
              <a href="{{ route('frontend.index') }}" class="app-brand-link"
                ...
                <img src="{{ asset('assets/backend/img/logo.png') }}" alt="Sundaram Corporation"
                  style="width: 280px !important; height: auto !important; max-width: 100% !important;" />
              </a>
            </div>
            <!-- /Logo -->
            <h4 class="mb-1 pt-2 text-center">Reset Password 🔒</h4>
            <p class="mb-4 text-center">for <span class="fw-medium">user@example.com</span></p>
            <form id="formAuthentication" action="#" method="GET">
              ...
              <button class="btn btn-primary d-grid w-100 mb-3"
                style="background: linear-gradient(270deg, #ba0001 0%, #e60000 100%); border: none;">Set new
                password</button>
              <div class="text-center">
                <a href="#" style="color: #ba0001;">
