                    ...
                    <form action="{{ route('admin.careers.store') }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('title') is-invalid @enderror" id="title" name="title" value="{{ old('title') }}" required placeholder="e.g. Mechanical Engineer">
                                @error('title')
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('job_type') is-invalid @enderror" id="job_type" name="job_type" value="{{ old('job_type', 'Full Time') }}" required placeholder="e.g. Full Time">
                                @error('job_type')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="mt-4">
                            <button type="submit" class="btn btn-primary me-2">Create Job Opening</button>
