                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="date" class="form-control @error('date') is-invalid @enderror" id="date"
                                    name="date" value="{{ old('date', $blog->date ? $blog->date->format('Y-m-d') : '') }}">
                                @error('date')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                                ...
                                @if($blog->image)
                                    <div class="mt-2">
                                        <img src="{{ asset('storage/' . $blog->image) }}" alt="Blog Image"
                                            class="rounded border" style="max-height: 100px;max-width: 100px;">
                                    </div>
                                @endif
                                @error('image')
                                    <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="url" name="instagram_link" id="instagram_link" class="form-control"
                                        value="{{ old('instagram_link', $blog->instagram_link) }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <textarea class="form-control" id="meta_keywords" name="meta_keywords" rows="2"
                                            placeholder="Enter keywords separated by commas">{{ old('meta_keywords', $blog->meta_keywords) }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-check form-switch">
                                    ...
                                    <input type="checkbox" class="form-check-input" value="Active" id="status" name="status"
                                        required {{ old('status', $blog->status) == 'Active' ? 'checked' : '' }}>
