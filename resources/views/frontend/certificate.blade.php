								...
								<div
									...
									<div style="border-radius: 10px; overflow: hidden; margin-bottom: 20px;">
										<img src="{{ asset('frontend/images/portfolio/portfolio-04.jpg') }}"
											class="img-fluid w-100" alt="Certificate 4"
											style="object-fit: cover; border-radius: 10px;">
									</div>
									<div class="pbmit-ihbox-contents">
										<h2 class="pbmit-element-title" style="font-size: 22px; margin-bottom: 5px;">
								...
								<div
									...
									<div style="border-radius: 10px; overflow: hidden; margin-bottom: 20px;">
										<img src="{{ asset('frontend/images/portfolio/portfolio-05.jpg') }}"
											class="img-fluid w-100" alt="Certificate 5"
											style="object-fit: cover; border-radius: 10px;">
									</div>
									<div class="pbmit-ihbox-contents">
										<h2 class="pbmit-element-title" style="font-size: 22px; margin-bottom: 5px;">
										...
										<div class="pbmit-heading-desc" style="color: #666;">Excellence in Engineering
										</div>
									</div>
								</div>
							</article>
								...
								<div
									...
									<div style="border-radius: 10px; overflow: hidden; margin-bottom: 20px;">
										<img src="{{ asset('frontend/images/portfolio/portfolio-06.jpg') }}"
											class="img-fluid w-100" alt="Certificate 6"
											style="object-fit: cover; border-radius: 10px;">
									</div>
									<div class="pbmit-ihbox-contents">
										<h2 class="pbmit-element-title" style="font-size: 22px; margin-bottom: 5px;">
										...
										<div class="pbmit-heading-desc" style="color: #666;">Innovation & Technology
										</div>
									</div>
								</div>
							</article>
