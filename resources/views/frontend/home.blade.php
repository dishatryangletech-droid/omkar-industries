					...
					<div class="swiper-wrapper">
						...
						<div class="swiper-slide">
							<div class="pbmit-slider-item">
								<div class="pbmit-slider-bg" style="background-image: url({{ asset('frontend/images/banner-slider-img/slider1-01.jpg') }});"></div>
								<div class="container">
						...
						<div class="swiper-slide">
							<div class="pbmit-slider-item">
								<div class="pbmit-slider-bg" style="background-image: url({{ asset('frontend/images/banner-slider-img/slider1-02.jpg') }});"></div>
								<div class="container">
									<div class="pbmit-slider-content">
										<h5 class="pbmit-slider-subtitle transform-right transform-delay-1">
											Forging the Future
						...
						<div class="swiper-slide">
							<div class="pbmit-slider-item">
								<div class="pbmit-slider-bg" style="background-image: url({{ asset('frontend/images/banner-slider-img/slider1-03.jpg') }});"></div>
								<div class="container">
									<div class="pbmit-slider-content">
										<h5 class="pbmit-slider-subtitle transform-right transform-delay-1">
											Forging the Future
										...
										<div class="pbmit-image-wrap">
											<div class="pbmit-featured-img-wrapper">
												<div class="pbmit-featured-wrapper">
													<img src="{{ asset('frontend/images/homepage-1/service/service-img-01.jpg') }}" class="img-fluid" alt="">
												</div>
											</div>
								...
								<div class="pbminfotech-post-item">
									<div class="pbmit-box-content-wrap">
										<div class="pbmit-image-wrap">
											<div class="pbmit-featured-img-wrapper">
												<div class="pbmit-featured-wrapper">
													<img src="{{ asset('frontend/images/homepage-1/service/service-img-02.jpg') }}" class="img-fluid" alt="">
												</div>
											</div>
											<div class="pbmit-service-icon-wrapper">
												<div class="pbmit-service-icon">
								...
								<div class="pbminfotech-post-item">
									<div class="pbmit-box-content-wrap">
										<div class="pbmit-image-wrap">
											<div class="pbmit-featured-img-wrapper">
												<div class="pbmit-featured-wrapper">
													<img src="{{ asset('frontend/images/homepage-1/service/service-img-03.jpg') }}" class="img-fluid" alt="">
												</div>
											</div>
											<div class="pbmit-service-icon-wrapper">
												<div class="pbmit-service-icon">
								...
								<div class="pbminfotech-post-item">
									<div class="pbmit-box-content-wrap">
										<div class="pbmit-image-wrap">
											<div class="pbmit-featured-img-wrapper">
												<div class="pbmit-featured-wrapper">
													<img src="{{ asset('frontend/images/homepage-1/service/service-img-04.jpg') }}" class="img-fluid" alt="">
												</div>
											</div>
											<div class="pbmit-service-icon-wrapper">
												<div class="pbmit-service-icon">
								...
								<div class="pbminfotech-post-item">
									<div class="pbmit-box-content-wrap">
										<div class="pbmit-image-wrap">
											<div class="pbmit-featured-img-wrapper">
												<div class="pbmit-featured-wrapper">
													<img src="{{ asset('frontend/images/homepage-1/service/service-img-05.jpg') }}" class="img-fluid" alt="">
												</div>
											</div>
											<div class="pbmit-service-icon-wrapper">
												<div class="pbmit-service-icon">
								...
								<div class="pbminfotech-post-item">
									<div class="pbmit-box-content-wrap">
										<div class="pbmit-image-wrap">
											<div class="pbmit-featured-img-wrapper">
												<div class="pbmit-featured-wrapper">
													<img src="{{ asset('frontend/images/homepage-1/service/service-img-06.jpg') }}" class="img-fluid" alt="">
												</div>
											</div>
											<div class="pbmit-service-icon-wrapper">
												<div class="pbmit-service-icon">
			...
			<section class="section-xl team-section-one fade-section pbmit-column-four">
				<div class="container">
								...
								<div class="pbminfotech-post-item">
									<div class="pbmit-featured-wrap">
										...
										<div class="pbmit-featured-inner">
											<div class="pbmit-featured-img-wrapper">
												<div class="pbmit-featured-wrapper">
													<img src="{{ asset('frontend/images/homepage-1/team/team-img-01.jpg') }}" class="img-fluid" alt="">
												</div>
											</div>
											<a class="pbmit-link" href="/team-member-detail"></a>
										</div>
									</div>
								...
								<div class="pbminfotech-post-item">
									<div class="pbmit-featured-wrap">
										...
										<div class="pbmit-featured-inner">
											<div class="pbmit-featured-img-wrapper">
												<div class="pbmit-featured-wrapper">
													<img src="{{ asset('frontend/images/homepage-1/team/team-img-02.jpg') }}" class="img-fluid" alt=""></div>
											</div>
											<a class="pbmit-link" href="/team-member-detail"></a>
										</div>
									</div>
								...
								<div class="pbminfotech-post-item">
									<div class="pbmit-featured-wrap">
										...
										<div class="pbmit-featured-inner">
											<div class="pbmit-featured-img-wrapper">
												<div class="pbmit-featured-wrapper">
													<img src="{{ asset('frontend/images/homepage-1/team/team-img-03.jpg') }}" class="img-fluid" alt=""></div>
											</div>
											<a class="pbmit-link" href="/team-member-detail"></a>
										</div>
									</div>
								...
								<div class="pbminfotech-post-item">
									<div class="pbmit-featured-wrap">
										...
										<div class="pbmit-featured-inner">
											<div class="pbmit-featured-img-wrapper">
												<div class="pbmit-featured-wrapper">
													<img src="{{ asset('frontend/images/homepage-1/team/team-img-04.jpg') }}" class="img-fluid" alt=""></div>
											</div>
											<a class="pbmit-link" href="/team-member-detail"></a>
										</div>
									</div>
								...
								<div class="pbminfotech-post-item">
									<div class="pbmit-featured-wrap">
										...
										<div class="pbmit-featured-inner">
											<div class="pbmit-featured-img-wrapper">
												<div class="pbmit-featured-wrapper">
													<img src="{{ asset('frontend/images/homepage-1/team/team-img-05.jpg') }}" class="img-fluid" alt=""></div>
											</div>
											<a class="pbmit-link" href="/team-member-detail"></a>
										</div>
									</div>
								...
								<div class="pbminfotech-post-item">
									<div class="pbmit-featured-wrap">
										...
										<div class="pbmit-featured-inner">
											<div class="pbmit-featured-img-wrapper">
												<div class="pbmit-featured-wrapper">
													<img src="{{ asset('frontend/images/homepage-1/team/team-img-06.jpg') }}" class="img-fluid" alt=""></div>
											</div>
											<a class="pbmit-link" href="/team-member-detail"></a>
										</div>
									</div>
					...
					<div class="pbmit-bottom-text">
						We are Always Dedicated to our Work. <a href="/our-team"><u>Become Part Of Our Team</u></a>
					</div>
				</div>
			</section>
			<!-- Team End -->
												...
												<div class="pbmit-ihbox-box">
													<div class="pbmit-ihbox-icon">
														<div class="pbmit-ihbox-icon-wrapper pbmit-ihbox-icon-type-image">
															<img src="{{ asset('frontend/images/ratting.png') }}" alt="">
														</div>
													</div>
													<div class="pbmit-ihbox-contents">
													...
													<article class="pbmit-testimonial-style-2 swiper-slide">
														<div class="pbminfotech-post-item">
															...
															<div class="pbminfotech-box-author">
																<div class="pbmit-featured-img-wrapper">
																	<div class="pbmit-featured-wrapper">
																		<img src="{{ asset('frontend/images/homepage-1/testimonial/testimonial-img-01.jpg') }}" class="img-fluid" alt="">
																	</div>
																</div>
													...
													<article class="pbmit-testimonial-style-2 swiper-slide">
														<div class="pbminfotech-post-item">
															...
															<div class="pbminfotech-box-author">
																<div class="pbmit-featured-img-wrapper">
																	<div class="pbmit-featured-wrapper">
																		<img src="{{ asset('frontend/images/homepage-1/testimonial/testimonial-img-02.jpg') }}" class="img-fluid" alt="">
																	</div>
																</div>
																<div class="pbmit-auther-content">
													...
													<article class="pbmit-testimonial-style-2 swiper-slide">
														<div class="pbminfotech-post-item">
															...
															<div class="pbminfotech-box-author">
																<div class="pbmit-featured-img-wrapper">
																	<div class="pbmit-featured-wrapper">
																		<img src="{{ asset('frontend/images/homepage-1/testimonial/testimonial-img-03.jpg') }}" class="img-fluid" alt="">
																	</div>
																</div>
																<div class="pbmit-auther-content">
				...
				<div class="container-fluid p-0">
					<div class="row g-0">
						<div class="col-md-4 first-col">
							<div class="accordion-img" {!! isset($faqSection) && $faqSection->photo ? 'style="background-image: url('.asset('storage/'.$faqSection->photo).')"' : '' !!}></div>
						</div>
								...
								<div class="row">
										...
										<div class="pbmit-ihbox-style-3">
											<div class="pbmit-ihbox-box">
												...
												<div class="pbmit-ihbox-contents">
													...
													<h2 class="pbmit-element-title">
														<a class="pbmit-button-inner" href="tel:{{ $faqSection->btn_title ?? '+1-234-567-89' }}">
															<span class="pbmit-button-content-wrapper">
																<span class="pbmit-button-text">{{ $faqSection->btn_title ?? '+1-234-567-89' }}</span>
															</span>
														</a>
													</h2>
													<h4 class="pbmit-element-subtitle">
														<a class="pbmit-button-inner" href="mailto:{{ $faqSection->btn_link ?? 'info@omkarindustries.com' }}">
															<span class="pbmit-button-content-wrapper">
																<span class="pbmit-button-text">
																	{{ $faqSection->btn_link ?? 'info@omkarindustries.com' }}
																</span>
															</span>
														</a>
													</h4>
									...
									<div class="col-md-12 col-xl-6">
										<div class="accordion" id="accordionExample1">
											...
											<div class="accordion-item {{ $key == 0 ? 'active' : '' }}" id="heading{{ $key }}">
