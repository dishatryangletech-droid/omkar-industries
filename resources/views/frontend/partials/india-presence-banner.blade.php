...
<a href="{{ url('our-product/tct-band-saw-blade-carbide-blade') }}" class="d-block text-decoration-none" style="color: inherit;">
	<div class="omkar-india-compact-banner mx-auto mt-2 mb-3"
		...
		<!-- Background subtle light yellow circle glow effect -->
		<div
			style="position: absolute; right: -40px; top: -40px; width: 180px; height: 180px; background: rgba(212, 136, 6, 0.09); border-radius: 50%; pointer-events: none;">
		</div>

		<div class="row align-items-center w-100 g-3 m-0">
			<!-- Left: 3 Attached Images Side-By-Side -->
			...
			<!-- Right Side: Content with Big & Bold Lettering -->
			<div class="col-lg-7 col-md-7 col-12 ps-lg-4 pe-0">
				<div class="d-flex flex-column justify-content-center h-100">
					<!-- Top Badge Header -->
					<div class="d-flex align-items-center gap-2 mb-1">
						<span class="badge px-2.5 py-1 text-uppercase fw-bold"
							style="background: rgba(212, 136, 6, 0.14); color: #856404; font-size: 11px; letter-spacing: 0.5px; border-radius: 12px;">
							PAN-INDIA DISTRIBUTION NETWORK
						</span>
					</div>

					<!-- Big and Bold Headline -->
					<h3 class="text-uppercase m-0 mb-2"
						style="font-size: 23px; font-weight: 900; color: #856404; line-height: 1.25; letter-spacing: -0.3px;">
						WE WORK ALL OVER INDIA <span style="color: #d48806;">THAT IN OMKAR ONLY</span>
					</h3>

					<!-- Quick Highlights Row -->
					<div class="d-flex flex-wrap align-items-center gap-3 mt-1"
						style="font-size: 13.5px; color: #6c5409; font-weight: 600;">
						<span><i class="fa fa-check-circle me-1" style="color: #d48806;"></i> Pan-India Supply</span>
						<span><i class="fa fa-check-circle me-1" style="color: #d48806;"></i> Looking For
							Distributors</span>
						<span><i class="fa fa-check-circle me-1" style="color: #d48806;"></i> TCT Bandsaw Blades</span>
					</div>
				</div>
			</div>
		</div>
...
<!-- Omkar India Wide Compact Banner Section End -->