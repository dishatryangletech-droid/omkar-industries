						...
						<article class="pbmit-portfolio-style-1 col-md-6 col-lg-4 col-xl-3 industrial">
							<div class="pbminfotech-post-content">
								<div class="pbminfotech-post-warpper">
									<div class="pbmit-featured-img-wrapper">
										<div class="pbmit-featured-wrapper">
											<img src="{{ asset('frontend/images/portfolio/portfolio-07.jpg') }}" class="img-fluid" alt="">
										</div>
									</div>
									<a class="pbmit-link" href="/portfolio-detail-style-01"></a>
								</div>
						...
						<article class="pbmit-portfolio-style-1 col-md-6 col-lg-4 col-xl-3 chemical">
							<div class="pbminfotech-post-content">
								<div class="pbminfotech-post-warpper">
									<div class="pbmit-featured-img-wrapper">
										<div class="pbmit-featured-wrapper">
											<img src="{{ asset('frontend/images/portfolio/portfolio-08.jpg') }}" class="img-fluid" alt="">
										</div>
									</div>
									<a class="pbmit-link" href="/portfolio-detail-style-01"></a>
								</div>
