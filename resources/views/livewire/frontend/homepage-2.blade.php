					...
					<div class="swiper-wrapper">
						...
						<div class="swiper-slide">
							<div class="pbmit-slider-item">
								<div class="pbmit-slider-bg" style="background-image: url({{ asset('frontend/images/banner-slider-img/slider2-01.jpg') }});"></div>
								<div class="container">
									<div class="row">
						...
						<div class="swiper-slide">
							<div class="pbmit-slider-item">
								<div class="pbmit-slider-bg" style="background-image: url({{ asset('frontend/images/banner-slider-img/slider2-02.jpg') }});"></div>
								<div class="container">
									<div class="row">
										<div class="col-md-8 col-1">
											<div class="pbmit-slider-content">
						...
						<div class="swiper-slide">
							<div class="pbmit-slider-item">
								<div class="pbmit-slider-bg" style="background-image: url({{ asset('frontend/images/banner-slider-img/slider2-03.jpg') }});"></div>
								<div class="container">
									<div class="row">
											...
											<div class="pbmit-image-wrap">
												<div class="pbmit-featured-img-wrapper">
													<div class="pbmit-featured-wrapper">
														<img src="{{ asset('frontend/images/homepage-2/service/service-img-01.jpg') }}" class="img-fluid" alt="">
													</div>
												</div>
									...
									<div class="pbminfotech-post-item">
										<div class="pbmit-box-content-wrap">
											<div class="pbmit-image-wrap">
												<div class="pbmit-featured-img-wrapper">
													<div class="pbmit-featured-wrapper">
														<img src="{{ asset('frontend/images/homepage-2/service/service-img-02.jpg') }}" class="img-fluid" alt="">
													</div>
												</div>
												<div class="pbmit-service-icon">
									...
									<div class="pbminfotech-post-item">
										<div class="pbmit-box-content-wrap">
											<div class="pbmit-image-wrap">
												<div class="pbmit-featured-img-wrapper">
													<div class="pbmit-featured-wrapper">
														<img src="{{ asset('frontend/images/homepage-2/service/service-img-03.jpg') }}" class="img-fluid" alt="">
													</div>
												</div>
												<div class="pbmit-service-icon">
													<svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1"><path d="m464.466 169.1h-13v-22.091a6.574 6.574 0 0 0 -6.565-6.574h-184.913a6.568 6.568 0 0 0 -6.564 6.574v97.191l13.129 5.457v-13.519h171.785v24.262.087s0 .057 0 .086v44.7.086s0 .057 0 .086v44.7.086s0 .057 0 .087v44.682.086s0 .057 0 .086v44.7.086s0 .057 0 .087v13.891h-85.18v-154.057l-147.975-61.51a3.033 3.033 0 0 1 -.544-.225l-23.285-9.678v225.465h-152.298v-333.293l81.916 34.042.047.019.619.253.038.019 89.193 37.062v30.319l13.131 5.458v-40.157a6.574 6.574 0 0 0 -4.042-6.067l-35.843-14.893-6.125-87.037a9.893 9.893 0 0 0 7.672-9.63v-15.212a9.9 9.9 0 0 0 -9.885-9.884h-50.219a9.9 9.9 0 0 0 -9.884 9.884v15.212a9.9 9.9 0 0 0 9.143 9.856l-6.574 59.437-83.229-34.586a6.573 6.573 0 0 0 -9.088 6.068v349.7a6.567 6.567 0 0 0 6.565 6.565h422.409a6.572 6.572 0 0 0 6.565-6.565v-13.981h31.473v13.98a6.567 6.567 0 1 0 13.133 0v-259.8a31.645 31.645 0 0 0 -31.605-31.6zm-345.666-111.041h43.729v8.722h-43.729zm9.228 21.851h26.811l5.711 81.147-39.678-16.486zm178.025 374.021v-112.179h-77.593v112.179h-13.13v-118.743a6.56 6.56 0 0 1 6.565-6.565h90.732a6.565 6.565 0 0 1 6.564 6.565v118.743zm145.415-155.131v-31.74h31.473v31.74zm31.473 13.133v31.74h-31.473v-31.74zm-31.473-58.006v-31.743h31.473v31.739zm0 102.879h31.473v31.712h-31.473zm13-174.573a18.5 18.5 0 0 1 18.473 18.467v8.347h-31.473v-26.818zm-26.128 3.22v13.129h-171.787v-13.133zm13.13 247.938v-31.74h31.473v31.74z"></path></svg>
									...
									<div class="pbminfotech-post-item">
										<div class="pbmit-box-content-wrap">
											<div class="pbmit-image-wrap">
												<div class="pbmit-featured-img-wrapper">
													<div class="pbmit-featured-wrapper">
														<img src="{{ asset('frontend/images/homepage-2/service/service-img-04.jpg') }}" class="img-fluid" alt="">
													</div>
												</div>
												<div class="pbmit-service-icon">
									...
									<div class="pbminfotech-post-item">
										<div class="pbmit-box-content-wrap">
											<div class="pbmit-image-wrap">
												<div class="pbmit-featured-img-wrapper">
													<div class="pbmit-featured-wrapper">
														<img src="{{ asset('frontend/images/homepage-2/service/service-img-05.jpg') }}" class="img-fluid" alt="">
													</div>
												</div>
												<div class="pbmit-service-icon">
									...
									<div class="pbminfotech-post-item">
										<div class="pbmit-box-content-wrap">
											<div class="pbmit-image-wrap">
												<div class="pbmit-featured-img-wrapper">
													<div class="pbmit-featured-wrapper">
														<img src="{{ asset('frontend/images/homepage-2/service/service-img-06.jpg') }}" class="img-fluid" alt="">
													</div>
												</div>
												<div class="pbmit-service-icon">
							...
							<div class="col-md-12 col-xl-9">
								<div class="row">
									...
									<div class="col-md-12 col-xl-6">
										...
										<div class="map-img">
											<img src="{{ asset('frontend/images/homepage-2/map.png') }}" class="img-fluid" alt="">
										</div>
									</div>
								</div>
							</div>
							...
							<div class="pbminfotech-post-item">
								<div class="pbminfotech-post-content">
									<div class="pbminfotech-warpper-image">
										<div class="pbmit-featured-img-wrapper">
											<div class="pbmit-featured-wrapper">
												<img src="{{ asset('frontend/images/homepage-2/portfolio/portfolio-img-01.jpg') }}" class="img-fluid" alt="">
											</div>
										</div>
									...
									<div class="pbminfotech-box-content">
										<div class="pbmit-portfolio-btn">
											<a class="pbmit-button-inner" href="/portfolio-detail-style-01" title="Automated Industry">
												<span class="pbmit-button-icon">
							...
							<div class="pbminfotech-post-item">
								<div class="pbminfotech-post-content">
									<div class="pbminfotech-warpper-image">
										<div class="pbmit-featured-img-wrapper">
											<div class="pbmit-featured-wrapper">
												<img src="{{ asset('frontend/images/homepage-2/portfolio/portfolio-img-02.jpg') }}" class="img-fluid" alt="">
											</div>
										</div>
										<a class="pbmit-link" href="/portfolio-detail-style-01"></a>
									</div>
									<div class="pbminfotech-box-content">
										<div class="pbmit-portfolio-btn">
											<a class="pbmit-button-inner" href="/portfolio-detail-style-01" title="Oil & Gas Industry">
												<span class="pbmit-button-icon">
													<i class="pbmit-base-icon-right"></i>
												</span>
											</a>
							...
							<div class="pbminfotech-post-item">
								<div class="pbminfotech-post-content">
									<div class="pbminfotech-warpper-image">
										<div class="pbmit-featured-img-wrapper">
											<div class="pbmit-featured-wrapper">
												<img src="{{ asset('frontend/images/homepage-2/portfolio/portfolio-img-03.jpg') }}" class="img-fluid" alt="">
											</div>
										</div>
										<a class="pbmit-link" href="/portfolio-detail-style-01"></a>
									</div>
									<div class="pbminfotech-box-content">
										<div class="pbmit-portfolio-btn">
											<a class="pbmit-button-inner" href="/portfolio-detail-style-01" title="Industry Innovation">
												<span class="pbmit-button-icon">
													<i class="pbmit-base-icon-right"></i>
												</span>
											</a>
							...
							<div class="pbminfotech-post-item">
								<div class="pbminfotech-post-content">
									<div class="pbminfotech-warpper-image">
										<div class="pbmit-featured-img-wrapper">
											<div class="pbmit-featured-wrapper">
												<img src="{{ asset('frontend/images/homepage-2/portfolio/portfolio-img-04.jpg') }}" class="img-fluid" alt="">
											</div>
										</div>
										<a class="pbmit-link" href="/portfolio-detail-style-01"></a>
									</div>
									<div class="pbminfotech-box-content">
										<div class="pbmit-portfolio-btn">
											<a class="pbmit-button-inner" href="/portfolio-detail-style-01" title="Tiling & Painting">
												<span class="pbmit-button-icon">
													<i class="pbmit-base-icon-right"></i>
												</span>
											</a>
							...
							<article class="pbmit-client-style-1 swiper-slide">
								<div class="pbmit-border-wrapper">
									<div class="pbmit-client-wrapper pbmit-client-with-hover-img">
										...
										<div class="pbmit-featured-img-wrapper">
											<div class="pbmit-featured-wrapper">
												<img src="{{ asset('frontend/images/client/client-06.png') }}" class="img-fluid" alt="">
											</div>
										</div>
									</div>
								</div>
								...
								<div class="pbminfotech-box-content">
									<div class="pbminfotech-box-content-inner">
										<div class="pbmit-featured-wrapper pbmit-hover-img">
											<div class="pbmit-featured-img-wrapper">
												<div class="pbmit-featured-wrapper">
													<img src="{{ asset('frontend/images/homepage-2/team/team-img-01.jpg') }}" class="img-fluid" alt="">
												</div>
											</div>
										</div>
								...
								<div class="pbminfotech-box-content">
									<div class="pbminfotech-box-content-inner">
										<div class="pbmit-featured-wrapper pbmit-hover-img">
											<div class="pbmit-featured-img-wrapper">
												<div class="pbmit-featured-wrapper">
													<img src="{{ asset('frontend/images/homepage-2/team/team-img-02.jpg') }}" class="img-fluid" alt="">
												</div>
											</div>
										</div>
										<h3 class="pbmit-team-title">
								...
								<div class="pbminfotech-box-content">
									<div class="pbminfotech-box-content-inner">
										<div class="pbmit-featured-wrapper pbmit-hover-img">
											<div class="pbmit-featured-img-wrapper">
												<div class="pbmit-featured-wrapper">
													<img src="{{ asset('frontend/images/homepage-2/team/team-img-03.jpg') }}" class="img-fluid" alt="">
												</div>
											</div>
										</div>
										<h3 class="pbmit-team-title">
								...
								<div class="pbminfotech-box-content">
									<div class="pbminfotech-box-content-inner">
										<div class="pbmit-featured-wrapper pbmit-hover-img">
											<div class="pbmit-featured-img-wrapper">
												<div class="pbmit-featured-wrapper">
													<img src="{{ asset('frontend/images/homepage-2/team/team-img-04.jpg') }}" class="img-fluid" alt="">
												</div>
											</div>
										</div>
										<h3 class="pbmit-team-title">
								...
								<div class="pbminfotech-box-content">
									<div class="pbminfotech-box-content-inner">
										<div class="pbmit-featured-wrapper pbmit-hover-img">
											<div class="pbmit-featured-img-wrapper">
												<div class="pbmit-featured-wrapper">
													<img src="{{ asset('frontend/images/homepage-2/team/team-img-05.jpg') }}" class="img-fluid" alt="">
												</div>
											</div>
										</div>
										<h3 class="pbmit-team-title">
								...
								<div class="pbminfotech-box-content">
									<div class="pbminfotech-box-content-inner">
										<div class="pbmit-featured-wrapper pbmit-hover-img">
											<div class="pbmit-featured-img-wrapper">
												<div class="pbmit-featured-wrapper">
													<img src="{{ asset('frontend/images/homepage-2/team/team-img-06.jpg') }}" class="img-fluid" alt="">
												</div>
											</div>
										</div>
										<h3 class="pbmit-team-title">
										...
										<article class="pbmit-testimonial-style-1 swiper-slide">
											<div class="pbminfotech-post-item">
												...
												<div class="pbminfotech-box-author">
													<div class="pbmit-featured-img-wrapper">
														<div class="pbmit-featured-wrapper">
															<img src="{{ asset('frontend/images/homepage-2/testimonial/testimonial-img-01.jpg') }}" class="img-fluid" alt="">
														</div>
													</div>
										...
										<article class="pbmit-testimonial-style-1 swiper-slide">
											<div class="pbminfotech-post-item">
												...
												<div class="pbminfotech-box-author">
													<div class="pbmit-featured-img-wrapper">
														<div class="pbmit-featured-wrapper">
															<img src="{{ asset('frontend/images/homepage-2/testimonial/testimonial-img-02.jpg') }}" class="img-fluid" alt="">
														</div>
													</div>
													<div class="pbmit-auther-content">
										...
										<article class="pbmit-testimonial-style-1 swiper-slide">
											<div class="pbminfotech-post-item">
												...
												<div class="pbminfotech-box-author">
													<div class="pbmit-featured-img-wrapper">
														<div class="pbmit-featured-wrapper">
															<img src="{{ asset('frontend/images/homepage-2/testimonial/testimonial-img-03.jpg') }}" class="img-fluid" alt="">
														</div>
													</div>
													<div class="pbmit-auther-content">
										...
										<article class="pbmit-testimonial-style-1 swiper-slide">
											<div class="pbminfotech-post-item">
												...
												<div class="pbminfotech-box-author">
													<div class="pbmit-featured-img-wrapper">
														<div class="pbmit-featured-wrapper">
															<img src="{{ asset('frontend/images/homepage-2/testimonial/testimonial-img-04.jpg') }}" class="img-fluid" alt="">
														</div>
													</div>
													<div class="pbmit-auther-content">
										...
										<article class="pbmit-testimonial-style-1 swiper-slide">
											<div class="pbminfotech-post-item">
												...
												<div class="pbminfotech-box-author">
													<div class="pbmit-featured-img-wrapper">
														<div class="pbmit-featured-wrapper">
															<img src="{{ asset('frontend/images/homepage-2/testimonial/testimonial-img-05.jpg') }}" class="img-fluid" alt="">
														</div>
													</div>
													<div class="pbmit-auther-content">
										...
										<article class="pbmit-testimonial-style-1 swiper-slide">
											<div class="pbminfotech-post-item">
												...
												<div class="pbminfotech-box-author">
													<div class="pbmit-featured-img-wrapper">
														<div class="pbmit-featured-wrapper">
															<img src="{{ asset('frontend/images/homepage-2/testimonial/testimonial-img-06.jpg') }}" class="img-fluid" alt="">
														</div>
													</div>
													<div class="pbmit-auther-content">
									...
									<div class="pbminfotech-box-content">
										<div class="pbmit-featured-container">
											<div class="pbmit-featured-container-inner">
												<div class="pbmit-featured-img-wrapper">
													<div class="pbmit-featured-wrapper">
														<img src="{{ asset('frontend/images/homepage-2/blog/blog-img-01.jpg') }}" class="img-fluid" alt="">
													</div>
												</div>
									...
									<div class="pbminfotech-box-content">
										<div class="pbmit-featured-container">
											<div class="pbmit-featured-container-inner">
												<div class="pbmit-featured-img-wrapper">
													<div class="pbmit-featured-wrapper">
														<img src="{{ asset('frontend/images/homepage-2/blog/blog-img-02.jpg') }}" class="img-fluid" alt="">
													</div>
												</div>
												<a class="pbmit-link" href="/blog-single-details"></a>
											</div>
									...
									<div class="pbminfotech-box-content">
										<div class="pbmit-featured-container">
											<div class="pbmit-featured-container-inner">
												<div class="pbmit-featured-img-wrapper">
													<div class="pbmit-featured-wrapper">
														<img src="{{ asset('frontend/images/homepage-2/blog/blog-img-03.jpg') }}" class="img-fluid" alt="">
													</div>
												</div>
												<a class="pbmit-link" href="/blog-single-details"></a>
											</div>
									...
									<div class="pbminfotech-box-content">
										<div class="pbmit-featured-container">
											<div class="pbmit-featured-container-inner">
												<div class="pbmit-featured-img-wrapper">
													<div class="pbmit-featured-wrapper">
														<img src="{{ asset('frontend/images/homepage-2/blog/blog-img-04.jpg') }}" class="img-fluid" alt="">
													</div>
												</div>
												<a class="pbmit-link" href="/blog-single-details"></a>
											</div>
									...
									<div class="pbminfotech-box-content">
										<div class="pbmit-featured-container">
											<div class="pbmit-featured-container-inner">
												<div class="pbmit-featured-img-wrapper">
													<div class="pbmit-featured-wrapper">
														<img src="{{ asset('frontend/images/homepage-2/blog/blog-img-05.jpg') }}" class="img-fluid" alt="">
													</div>
												</div>
												<a class="pbmit-link" href="/blog-single-details"></a>
											</div>
									...
									<div class="pbminfotech-box-content">
										<div class="pbmit-featured-container">
											<div class="pbmit-featured-container-inner">
												<div class="pbmit-featured-img-wrapper">
													<div class="pbmit-featured-wrapper">
														<img src="{{ asset('frontend/images/homepage-2/blog/blog-img-06.jpg') }}" class="img-fluid" alt="">
													</div>
												</div>
												<a class="pbmit-link" href="/blog-single-details"></a>
											</div>
