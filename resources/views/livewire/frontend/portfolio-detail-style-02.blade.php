					...
					<article class="pbmit-portfolio-single">
						<div class="pbmit-single-project-details-wrapper">
							<div class="pbmit-featured-img-wrapper">
								<img src="{{ asset('frontend/images/portfolio/portfolio-single-02.webp') }}" alt="">
							</div>
						</div>
						<div class="row">
									...
									<div class="row pb-md-5 pb-3">
										<div class="col-md-6">
											<div class="pbmit-animation-style7">
												<img src="{{ asset('frontend/images/portfolio/portfolio-detail-01s.jpg') }}" class="pf-detail-img img-fluid" alt="">
											</div>
										</div>
										<div class="col-md-6">
											<div class="pbmit-animation-style7">
												<img src="{{ asset('frontend/images/portfolio/portfolio-detail-02s.jpg') }}" class="pf-detail-img img-fluid" alt="">
											</div>
										</div>
									</div>
									<div data-aos="fade-up" data-aos-duration="800">
